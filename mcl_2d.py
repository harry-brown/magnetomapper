...
# date: 2/6/17
#
# demonstrates the monte carlo localization method in 2-dimensions using
# randomly generated map data and measurements generated by reading the
# map and applying some random noise
#
...
if __name__ == "__main__":
    ...
    # map of hallway
    hall_map = numpy.random.rand(100,100)
    ...
    sensor_seq = sensor_seq + (numpy.random.randn(sensor_seq.size)*noise_percentage)
