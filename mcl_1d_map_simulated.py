# mcl_1d_map_simulated.py
# author: Tom Molnar
# date: 8/6/17
#
# performs the localization using the captured map data, but with simulated
# measurements generated by reading the map and applying some random noise
#
